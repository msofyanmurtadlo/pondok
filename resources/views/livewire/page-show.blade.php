<div>
    <div class="relative py-20 md:py-32 text-white text-center bg-cover bg-center"
        @if ($page->image) style="background-image: url('{{ asset('storage/' . $page->image) }}');" @else style="background-color: #1a202c;" @endif>
        {{-- Dark overlay --}}
        <div class="absolute inset-0 bg-black opacity-50"></div>
        <div class="relative container mx-auto px-6 z-10">
            <h1 class="text-4xl md:text-6xl font-extrabold leading-tight mb-4">{{ $page->title }}</h1>
